...
This documentation refers to C<Kafka> package version 0.800_13 .
...
With non-empty timeout, we use alarm internally and try preserving existing alarm if possible.
...
For C<gethostbyname> operations the non-empty timeout is rounded to the nearest positive integer;
